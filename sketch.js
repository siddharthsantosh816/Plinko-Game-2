...
var plinkos=[];
var divisions=[];
var score=0, attempts=5, pCount=0;
var PLAY=1;
var END=0;
var gameState=PLAY;
...
function draw() {
    ...
    //scoring
    if(check===0 && particles.length>0 && R===0){
        if(particles[num].body.position.y>460 &&particles[num].body.position.x > 5 && particles[num].body.position.x < 795 ){
